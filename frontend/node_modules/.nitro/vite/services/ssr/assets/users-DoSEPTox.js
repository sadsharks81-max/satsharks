...
import { u as useAuth, a as api } from "./router-CR3xljxi.js";
...
function AdminUsers() {
  ...
  const updateRole = async (id, current) => {
    const nextRole = current === "STUDENT" ? "TEACHER" : "STUDENT";
    const res = await api.put(`/api/users/${id}/role`, {
      role: nextRole
    });
    if (res.success) {
      setUsersList((prev) => prev.map((u) => u._id === id ? {
      ...
      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-outline-variant/20", children: usersList.map((u) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-surface-container-low/50 transition-colors", children: [
        /* @__PURE__ */ jsxs("td", { className: "p-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "font-semibold", children: [
            ...
            u.role === "TEACHER" && /* @__PURE__ */ jsx(Badge, { variant: "info", className: "ml-2 bg-info/10 text-info border border-info/20", children: "TEACHER" })
          ] }),
        ...
        /* @__PURE__ */ jsx("td", { className: "p-4", children: u.role !== "ADMIN" && /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsx("button", { onClick: () => updateRole(u._id, u.role), className: "px-3 py-1 bg-primary/10 text-primary hover:bg-primary/20 rounded text-sm transition-colors cursor-pointer", children: u.role === "STUDENT" ? "Make Teacher" : "Make Student" }),
