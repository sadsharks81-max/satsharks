...
async function run() {
    ...
    if (docxFile) {
        const p = path_1.default.join(dir, docxFile);
    ...
    if (docxSolFile) {
        const p = path_1.default.join(dir, docxSolFile);
    ...
    if (pdfFile) {
        const p = path_1.default.join(dir, pdfFile);
    ...
    if (pdfSolFile) {
        const p = path_1.default.join(dir, pdfSolFile);
