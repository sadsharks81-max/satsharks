...
router.get("/history/all", auth_middleware_1.authenticate, (0, role_middleware_1.requireActiveUser)(), analytics_controller_1.getUnifiedHistory);
...
router.get("/student-reports", auth_middleware_1.authenticate, (0, role_middleware_1.requireAdminOrTeacher)(), analytics_controller_1.getStudentProgressReports);
