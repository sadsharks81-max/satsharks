...
router.get("/homepage", success_stories_controller_1.getHomepageSuccessContent);
router.get("/featured", success_stories_controller_1.getHeroFeature);
router.get("/featured/image", success_stories_controller_1.getHeroFeatureImage);
router.get("/image/:id", success_stories_controller_1.getSuccessStoryImage);
