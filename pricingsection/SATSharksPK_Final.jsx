      ...
      {open && (
        <div className="px-5 pb-5">
          ...
          <div className="p-3 rounded-xl mb-4 flex gap-3 items-start" style={{ backgroundColor: "#fefce8" }}>
            ...
            <div>
              <h5 className="text-xs font-bold mb-0.5" style={{ color: "#92400e" }}>Extracurricular Edge</h5>
              <p className="text-xs leading-relaxed" style={{ color: "#a16207" }}>{ecNote}</p>
            </div>
          </div>
          ...
          <p className="text-center text-xs font-semibold mt-4 py-2 rounded-lg" style={{ backgroundColor: "#f0fdf4", color: "#166534" }}>
            ✦ And many more scholarships and financial aid opportunities available. We match you with the ones that fit your profile best.
          </p>
        </div>
      )}
    </div>
...
export default function SATSharksPKFinal() {
  ...
  const [form, setForm] = useState({ name:"", email:"", phone:"", city:"", year:"" });
    ...
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "'Inter','Segoe UI',system-ui,sans-serif" }}>
      ...
      <nav className="bg-white px-5 py-3.5 flex items-center justify-between border-b border-gray-100 sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <span className="text-lg font-black tracking-tight" style={{ color: "#0f1b2d" }}>SAT</span>
          <span className="text-lg font-black tracking-tight" style={{ color: "#0ea5e9" }}>Sharks</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <section className="px-5 pt-12 pb-14 text-center" style={{ background: "linear-gradient(165deg, #0f1b2d 0%, #1a2744 50%, #1e3054 100%)" }}>
        <span className="inline-block text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-5" style={{ backgroundColor: "#f59e0b", color: "#0f1b2d" }}>Admissions Counselling for Pakistani Students</span>
        <h1 className="text-3xl font-extrabold text-white leading-tight mb-2">Pakistan Se Duniya Tak.</h1>
        <h1 className="text-3xl font-extrabold leading-tight mb-5" style={{ color: "#f59e0b" }}>Your Dream University Awaits.</h1>
        <p className="text-sm leading-relaxed max-w-md mx-auto mb-6" style={{ color: "#94a3b8" }}>
          We don't just write essays. We build your entire profile from scratch. Extracurriculars, research, competitions, 
          personal statements, school selection, scholarship strategy. Everything except the visa. From zero to acceptance letter.
        </p>
      ...
      <section className="px-4 py-10 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { icon:"🎯", title:"Strategic School Matching", desc:"Data backed university selection that goes beyond rankings. We match you with schools and programs where your specific profile has the highest chance of admission and scholarships." },
            ...
            <div key={i} className="bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-sm font-bold mb-2" style={{ color: "#0f1b2d" }}>{d.title}</h3>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-3">
          {countries.map(co => (
            <button key={co.id} onClick={() => { setSelected(co.id); setTimeout(() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' }), 100); }}
              ...
              <span className="text-xs font-semibold text-center leading-tight" style={{ color: "#0f1b2d" }}>{co.name}</span>
            </button>
          ))}
        </div>
      </section>
      ...
      {c && (
        <section className="px-4 pb-10 max-w-5xl mx-auto" id="pricing">
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl font-bold" style={{ color: "#0f1b2d" }}>{c.name}</h2>
            <p className="text-sm mt-1" style={{ color: "#64748b" }}>{c.tagline}</p>
          </div>
              ...
              <div className="px-6 pt-6 pb-4">
                <div className="flex items-center gap-2.5 mb-1">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#e0f2fe" }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                  </div>
                  <h3 className="text-lg font-bold" style={{ color: "#0f1b2d" }}>Guided Support</h3>
                </div>
                <p className="text-xs mb-4" style={{ color: "#64748b" }}>We guide, you write, with expert eyes on every draft.</p>
                <div className="flex items-baseline gap-1 mb-1"><span className="text-3xl font-extrabold" style={{ color: "#0f1b2d" }}>Rs. {c.t1}</span></div>
                <p className="text-xs mb-4" style={{ color: "#94a3b8" }}>{c.t1l} PKR</p>
              </div>
            ...
            <div className="flex-1 rounded-2xl overflow-hidden flex flex-col relative" style={{ border: "2px solid #f59e0b", background: "white" }}>
              ...
              <div className="px-6 pt-6 pb-4">
                <div className="flex items-center gap-2.5 mb-1">
                  ...
                  <h3 className="text-lg font-bold" style={{ color: "#0f1b2d" }}>Complete Package</h3>
                </div>
                <p className="text-xs mb-4" style={{ color: "#64748b" }}>We handle everything. You just show up and get accepted.</p>
                <div className="flex items-baseline gap-1 mb-1"><span className="text-3xl font-extrabold" style={{ color: "#0f1b2d" }}>Rs. {c.t2}</span></div>
                <p className="text-xs mb-4" style={{ color: "#94a3b8" }}>{c.t2l} PKR</p>
              </div>
              <div className="px-6 pb-6 flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={i} className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <h3 className="text-sm font-bold mb-2" style={{ color: "#0f1b2d" }}>{t.title}</h3>
      ...
      <section className="px-5 py-10 text-center" style={{ backgroundColor: "#0f1b2d" }}>
        ...
        <p className="text-xs leading-relaxed max-w-md mx-auto mb-6" style={{ color: "#94a3b8" }}>
          From Lahore to Karachi, Islamabad to Peshawar. We have helped students across Pakistan build profiles, win scholarships, and land admits at dream schools in 15 countries. 
          We cover everything except the visa. We don't do cookie cutter. Neither should you.
        </p>
            ...
            {!done ? (
              <div className="px-6 py-6 flex flex-col gap-4">
                ...
                <div><label className="block text-xs font-semibold mb-1.5" style={{ color: "#0f1b2d" }}>City *</label>
                  <select value={form.city} onChange={e => setForm({...form, city: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-400 bg-white">
                    <option value="">Select city</option>{["Lahore","Karachi","Islamabad","Rawalpindi","Peshawar","Faisalabad","Multan","Quetta","Other"].map(c => <option key={c} value={c}>{c}</option>)}
                  </select>
                </div>
              ...
              <div className="px-6 py-10 text-center">
                ...
                <button className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-white font-semibold text-sm" style={{ backgroundColor: "#25D366" }} onClick={() => window.open(`https://wa.me/${WA}?text=${encodeURIComponent(`Hi! I just registered. My name is ${form.name} from ${form.city}.`)}`, "_blank")}><WAIcon />Message Us Directly</button>
              </div>
            )}
          </div>
        </div>
