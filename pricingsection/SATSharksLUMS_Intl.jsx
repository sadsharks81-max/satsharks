  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          LUMS Admissions for International Students
        </span>
            ...
            {!done ? (
              ...
              <div className="px-6 py-10 text-center">
                ...
                <button
                  ...
                  onClick={() =>
                    window.open(
                      `https://wa.me/${WA}?text=${encodeURIComponent(`Hi! I just registered for LUMS counselling. My name is ${form.name} from ${form.country}.`)}`,
                      "_blank",
                    )
                  }
                >
