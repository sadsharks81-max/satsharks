...
export default function SATSharksLUMSIntl() {
  const [showReg, setShowReg] = useState(false);
  const [selTier, setSelTier] = useState("");
  const [form, setForm] = useState({ name:"", email:"", phone:"", country:"", program:"" });
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "'Inter','Segoe UI',system-ui,sans-serif" }}>
      ...
      <section className="px-5 pt-14 pb-10 text-center" style={{ background: "linear-gradient(165deg, #0f1b2d 0%, #1a2744 50%, #1e3054 100%)" }}>
        <span className="inline-block text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-6" style={{ backgroundColor: "#f59e0b", color: "#0f1b2d" }}>LUMS Admissions for International Students</span>
        ...
        <div className="flex flex-col lg:flex-row gap-5 items-stretch">
          ...
          <div className="flex-1 bg-white rounded-2xl border border-gray-200 overflow-hidden flex flex-col">
            <div className="px-6 pt-6 pb-4">
              ...
              <p className="text-xs mb-4" style={{ color: "#94a3b8" }}>USD</p>
            </div>
          ...
          <div className="flex-1 rounded-2xl overflow-hidden flex flex-col relative bg-white" style={{ border: "2px solid #f59e0b" }}>
            ...
            <div className="px-6 pt-6 pb-4">
              ...
              <div className="flex items-baseline gap-1 mb-1"><span className="text-3xl font-extrabold" style={{ color: "#0f1b2d" }}>$550</span></div>
              <p className="text-xs mb-4" style={{ color: "#94a3b8" }}>USD</p>
            </div>
            <div className="px-6 pb-6 flex-1 flex flex-col">
      ...
      {showReg && (<div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: "rgba(15,27,45,0.7)", backdropFilter: "blur(4px)" }} onClick={e => { if (e.target === e.currentTarget) setShowReg(false); }}>
        <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl relative max-h-screen overflow-y-auto">
          ...
          {!done ? (<div className="px-6 py-6 flex flex-col gap-4">
            ...
            <div><label className="block text-xs font-semibold mb-1.5" style={{ color: "#0f1b2d" }}>WhatsApp Number</label><input value={form.phone} onChange={e => setForm({...form, phone: e.target.value})} placeholder="+971 XX XXX XXXX" className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-400" /></div>
            <div><label className="block text-xs font-semibold mb-1.5" style={{ color: "#0f1b2d" }}>Country *</label>
              <select value={form.country} onChange={e => setForm({...form, city: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none bg-white">{["","UAE","Saudi Arabia","Qatar","Bahrain","Kuwait","Oman","United Kingdom","United States","Canada","Turkey","Afghanistan","Other"].map(c => <option key={c} value={c}>{c || "Select country"}</option>)}</select>
            </div>
