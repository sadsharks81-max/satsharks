...
const portalOnlyFeatures = [
  ...
  { cat:"Leaderboard and Community", items:["See how you rank against other SAT Sharks students across Pakistan","Healthy competition drives better scores and keeps motivation high","Report any issue directly through the portal and our 24/7 dedicated support team will resolve it"] }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "'Inter','Segoe UI',system-ui,sans-serif" }}>
      ...
      <section className="px-5 pt-12 pb-14 text-center" style={{ background: "linear-gradient(165deg, #1a0533 0%, #2d1054 50%, #1a0533 100%)" }}>
        <span className="inline-block text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-5" style={{ backgroundColor: "#f59e0b", color: "#0f1b2d" }}>SAT Preparation for Pakistani Students</span>
        ...
        <div className="flex flex-col lg:flex-row gap-5 items-stretch">
          ...
          <div className="flex-1 bg-white rounded-2xl border border-gray-200 overflow-hidden flex flex-col">
            <div className="px-6 pt-6 pb-4">
              ...
              <p className="text-xs mb-4" style={{ color: "#64748b" }}>Self study at your own pace with the most powerful SAT prep platform in Pakistan.</p>
              <div className="flex items-baseline gap-1 mb-1"><span className="text-3xl font-extrabold" style={{ color: "#0f1b2d" }}>Rs. 15,000</span></div>
          ...
          <div className="flex-1 bg-white rounded-2xl border border-gray-200 overflow-hidden flex flex-col">
            <div className="px-6 pt-6 pb-4">
              ...
              <div className="flex items-baseline gap-1 mb-1"><span className="text-3xl font-extrabold" style={{ color: "#0f1b2d" }}>Rs. 40,000</span></div>
          ...
          <div className="flex-1 rounded-2xl overflow-hidden flex flex-col relative" style={{ border: "2px solid #f59e0b", background: "white" }}>
            ...
            <div className="px-6 pt-6 pb-4">
              ...
              <div className="flex items-baseline gap-1 mb-1"><span className="text-3xl font-extrabold" style={{ color: "#0f1b2d" }}>Rs. 1,00,000</span></div>
              <p className="text-xs mb-4" style={{ color: "#94a3b8" }}>Per month</p>
            </div>
            <div className="px-6 pb-6 flex-1 flex flex-col">
      ...
      <section className="px-4 py-10 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            { icon:"🚀", title:"The Portal Advantage", desc:"No other SAT prep in Pakistan gives you a full adaptive testing portal with 5,000+ questions, smart analytics, custom test builder, vocabulary games, leaderboard, and an interface identical to the real digital SAT." }
          ].map((t,i) => (
      ...
      <section className="px-5 py-10 text-center" style={{ background: "linear-gradient(135deg, #1a0533, #2d1054)" }}>
        ...
        <p className="text-xs leading-relaxed max-w-md mx-auto mb-6" style={{ color: "#a78bfa" }}>Real papers. Real conditions. Real strategies. A portal that knows your weak spots better than you do. From Lahore to Karachi, Islamabad to Peshawar, our students don't just improve, they dominate.</p>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl relative max-h-screen overflow-y-auto">
            ...
            {!done ? (
              <div className="px-6 py-6 flex flex-col gap-4">
                ...
                <div><label className="block text-xs font-semibold mb-1.5" style={{ color: "#0f1b2d" }}>WhatsApp Number</label><input value={form.phone} onChange={e => setForm({...form, phone: e.target.value})} placeholder="03XX XXXXXXX" className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-purple-400" /></div>
