...
const countries = [
  {
    ...
    guided: [
      {
        ...
        items: [
          "Work one on one with a counsellor who has placed students in Top 30 US schools",
    ...
    scholarships: [
      ...
      },
      {
        ...
        detail: "Provides grants, not loans. Same policy for all students",
      },
      {
        name: "Stamps Scholarship",
        detail:
          "Available at 40+ partner universities. Full cost of attendance plus enrichment funds",
      },
      {
      ...
      },
      {
        ...
        detail: "Full funding for graduate studies. Open to all countries",
      },
      {
        name: "Duke Karsh International Scholarship",
        detail: "Full cost of attendance for four years",
      },
    ],
  },
  {
    ...
    guided: [
      {
        ...
        items: [
          "Craft a compelling profile Canadian universities specifically look for",
          "Move beyond generic responses committees skim past",
      ...
      },
      {
        ...
        items: [
          "Guided approach to supplementals for UBC, Waterloo, McGill, and more",
          "Each response reflects what individual programs value",
          "Strategic emphasis on community and leadership",
        ],
      },
      {
        cat: "Application Alignment",
        items: [
          "Profile, supplementals, and extracurriculars as one cohesive story",
          "Every section reinforces one compelling narrative",
        ],
      },
    ],
    complete: [
      {
        ...
        items: [
          "Complete profile and all supplementals from scratch",
          "Deep interviews to capture your authentic voice",
          "Unlimited revisions",
        ],
      },
      {
        ...
        items: [
          "Our EC developers help you build meaningful community projects and volunteer leadership",
          "Design research collaborations Canadian schools value",
      ...
      },
      {
        ...
        items: [
          "Strategic list matching your academic and career goals",
          "Entrance scholarship identification at each target",
          "Timing and strategy optimized per institution",
        ],
      },
      {
        cat: "Research and Portfolio Preparation",
        items: [
          "Research and project work guidance for STEM applicants",
          "Portfolio support for creative programs",
          "Recommendation strategy and guidance",
        ],
      },
    ],
    scholarships: [
      {
        ...
        detail: "Covers tuition, books, fees, and residence for four years",
      },
      {
        name: "Schulich Leader Scholarships",
        detail: "Up to $120,000 for STEM students at 20 Canadian universities",
      },
      {
        name: "UBC International Scholars",
        detail: "Awards from $10,000 to full tuition",
      },
      {
        name: "McGill Entrance Scholarships",
        detail: "Merit awards up to $12,000 per year",
      },
      {
      ...
      {
        name: "Waterloo Merit Scholarships",
        detail: "$5,000 to $25,000 for high achieving applicants",
      },
    ],
  },
  {
    ...
    guided: [
      {
        ...
        items: [
          "Subject focused statement demonstrating genuine academic curiosity",
          "Structured to stand out across all five UCAS choices",
          "Feedback until every paragraph serves a purpose",
        ],
      },
      {
        cat: "Supercurricular Development",
        items: [
          "Reading, research, and projects woven into your academic profile",
          "Supercurriculars showing depth of subject interest",
          "Wider participation demonstrating a well rounded applicant",
        ],
      },
      {
        cat: "Course Selection Strategy",
        items: [
          "Strategic five UCAS choices balancing ambition with realistic targets",
          "Statement aligned across multiple programs",
        ],
      },
    ],
    complete: [
      {
        ...
        items: [
          "Complete statement from scratch",
          "Deep interviews to surface academic passion",
          "Unlimited revisions",
        ],
      },
      {
        ...
        items: [
          "Our EC developers design extended research projects and academic initiatives",
          "Build olympiad participation, essay competitions, and conference presentations",
          "Create supercurricular depth that separates you from thousands",
        ],
      },
      {
        cat: "Oxbridge and Top University Strategy",
        items: [
          "Strategy for Oxford, Cambridge, Imperial, UCL, and LSE",
          "Admissions test, assessment, and interview preparation",
          "Subject specific advice on demonstrating academic depth",
        ],
      },
      {
        cat: "Scholarship Strategy",
        items: [
          "University specific scholarships and bursaries identified",
          "Chevening, Commonwealth, and named scholarship guidance",
          "Funding strategy to reduce cost of attendance",
        ],
      },
    ],
    scholarships: [
      {
        ...
        detail:
          "UK Government funded. Full tuition, living, and travel for one year Masters",
      },
      {
        name: "Gates Cambridge Scholarship",
        detail:
          "Full cost at Cambridge including tuition, maintenance, and travel",
      },
      {
        name: "Rhodes Scholarship (Oxford)",
        detail: "Fully funded postgraduate study for up to three years",
      },
      {
        name: "Clarendon Fund (Oxford)",
        detail: "Tuition and living for graduate students",
      },
      {
        name: "Think Big Scholarships (Bristol)",
        detail: "Awards up to full tuition",
      },
      {
        name: "Edinburgh Global Scholarships",
        detail: "Significant tuition reductions for Masters students",
      },
    ],
  },
  {
    ...
    guided: [
      {
        ...
        items: [
          "Compelling letter German universities require",
          "Academic readiness and genuine interest demonstrated",
          "Feedback aligned to German expectations",
        ],
      },
      {
        cat: "APS and Uni Assist Guidance",
        items: [
          "Step by step APS certification support",
          "Uni-assist portal document preparation",
      ...
      },
      {
        cat: "Application Alignment",
        items: [
          "Letter, profile, and extracurriculars presented cohesively",
          "Every element reinforces readiness for German academia",
        ],
      },
    ],
    complete: [
      {
        ...
        items: [
          "Complete letter from scratch per university",
          "Deep interviews capturing your vision",
          "Unlimited revisions",
        ],
      },
      {
        cat: "Technical Profile Development",
        items: [
          "Our EC developers guide you through technical projects, coding portfolios, and research",
          "Build verifiable STEM achievements German universities value",
          "Create industry relevant certifications and documentation",
        ],
      },
      {
        cat: "Full APS and Application Management",
        items: [
          "Complete APS support start to finish",
          "All uni-assist applications prepared",
          "Document preparation, translation, and deadline management",
        ],
      },
      {
        cat: "Scholarship Applications",
        items: [
          "DAAD, Erasmus, and university scholarships identified",
          "All essays and documents prepared",
          "Financial planning for Germany",
        ],
      },
    ],
    scholarships: [
      {
        ...
        detail:
          "Germany's largest scholarship organization with programs at all levels",
      },
      {
      ...
      },
      {
        ...
        detail: "€300 per month merit scholarship",
      },
      {
        name: "Heinrich Boll Foundation",
        detail: "Full funding for international students",
      },
      {
        name: "Friedrich Ebert Foundation",
        detail: "Monthly stipend plus tuition",
      },
    ],
  },
  {
    ...
    t2: "$3,500",
    tagline:
      "MEXT, world class universities, and academic excellence. We open the door.",
    ecHighlight:
      "We help you develop published research papers, conference presentations, and faculty collaboration projects that MEXT reviewers and Japanese professors specifically look for",
    guided: [
      {
        cat: "Research Proposal, Collaborative Deep Dive",
        items: [
          "Proposal aligned with Japanese faculty interests",
          "Clear research direction and potential demonstrated",
          "Feedback from counsellors experienced with Japanese admissions",
        ],
      },
      {
        cat: "Faculty Contact Strategy",
        items: [
          "Identifying and approaching potential supervisors",
          "Professional communication strategy",
          "Building academic connection before formal application",
        ],
      },
      {
        cat: "Application Alignment",
        items: [
          "Proposal, statement, and profile presented cohesively",
          "Every element demonstrates fit for Japanese academia",
        ],
      },
    ],
    complete: [
      {
        ...
        items: [
          "Complete proposal and statement from scratch",
          "Deep interviews on your research interests",
          "Unlimited revisions until faculty ready",
        ],
      },
      {
        cat: "Research Profile Development",
        items: [
          "Our team guides you through publishing a research paper or presenting at a conference",
          "Build a credible research portfolio before you apply",
          "Create the track record that makes professors want to supervise you",
        ],
      },
      {
        cat: "Full MEXT Application Support",
        items: [
          "Complete MEXT application prepared start to finish",
          "Study plan, research plan, and documents polished",
          "Embassy and university track strategy",
        ],
      },
      {
        cat: "Scholarship Strategy",
        items: [
          "MEXT, JASSO, and university scholarships identified",
          "All materials prepared",
          "Financial planning for Japan",
        ],
      },
    ],
    scholarships: [
      {
        ...
        detail:
          "Fully funded. Tuition, 143,000+ yen monthly stipend, and airfare",
      },
      {
        name: "JASSO Student Exchange Support",
        detail: "80,000 yen monthly stipend",
      },
      {
        name: "University of Tokyo PEAK Scholarships",
        detail: "Full tuition and monthly stipend for undergraduates",
      },
      {
        name: "ADB Japan Scholarship",
        detail: "Full tuition and living for ADB member country students",
      },
      {
        name: "Kyoto University International Scholarships",
        detail: "Multiple programs for graduate students",
      },
    ],
  },
  {
    ...
    guided: [
      {
        ...
        items: [
          "Statement Korean universities look for",
          "Academic motivation and genuine interest demonstrated",
          "Feedback aligned to Korean standards",
        ],
      },
      {
        cat: "Study Plan Development",
        items: [
          "Detailed plan showing academic and career direction",
          "Research alignment with programs and faculty",
          "Language and cultural integration strategy",
        ],
      },
      {
        cat: "Application Alignment",
        items: [
          "Statement, plan, and profile as one cohesive package",
          "Every element reinforces commitment",
        ],
      },
    ],
    complete: [
      {
        ...
        items: [
          "Complete statement and plan from scratch",
          "Deep interviews capturing motivations",
          "Unlimited revisions",
        ],
      },
      {
        ...
        items: [
          "Our EC developers help build innovation, tech, or social impact projects",
          "Create entrepreneurship or cultural initiatives that stand out",
          "Develop achievements Korean universities specifically value",
        ],
      },
      {
        cat: "Full KGSP Application Support",
        items: [
          "Complete KGSP application prepared",
      ...
      },
      {
        cat: "Scholarship Strategy",
        items: [
          "KGSP, university, and foundation scholarships",
          "All materials prepared",
          "Financial planning for Korea",
        ],
      },
    ],
    scholarships: [
      {
        name: "KGSP",
        detail:
          "Fully funded. Tuition, stipend, airfare, settlement, and Korean language training",
      },
      {
        name: "Korea University International Scholarship",
        detail: "Up to full tuition waiver",
      },
      {
        name: "Yonsei Global Leader Fellowship",
        detail: "Full tuition for top applicants",
      },
      {
        name: "KAIST International Scholarship",
        detail: "Full tuition plus monthly allowance",
      },
      {
        name: "Seoul National University Scholarship",
        detail: "Partial to full tuition for graduates",
      },
    ],
  },
  {
    ...
    guided: [
      {
        ...
        items: [
          "Clear study plan meeting CSC standards",
          "Academic goals and reasons for China demonstrated",
      ...
      },
      {
        ...
        items: [
          "Statement tailored to Chinese expectations",
          "Achievements presented effectively",
          "Motivation connected to your program",
        ],
      },
      {
        cat: "Application Alignment",
        items: [
          "Plan, statement, and documents aligned cohesively",
    ...
    complete: [
      {
        cat: "Study Plan and Statement, Written For You",
        items: [
          "Complete plan and statement from scratch",
          "Deep interviews",
          "Unlimited revisions",
        ],
      },
      {
        ...
        items: [
          "Our team helps build academic competition results and community projects",
          "Create achievements that make your CSC application stand out",
          "Develop leadership and academic commitment",
        ],
      },
      {
        cat: "Full CSC Application Support",
        items: [
          "Complete CSC application prepared end to end",
          "University acceptance letter strategy",
          "All documents polished",
        ],
      },
      {
        cat: "Scholarship Strategy",
        items: [
          "CSC, Confucius, provincial, and university scholarships",
          "All materials prepared",
    ...
    scholarships: [
      {
        ...
        detail: "Fully funded. Tuition, accommodation, stipend, and insurance",
      },
      {
        name: "Confucius Institute Scholarship",
        detail: "Full or partial funding for language programs",
      },
      {
      ...
      },
      {
        ...
        detail: "Full tuition and living stipend",
      },
      {
        name: "Peking University Scholarships",
  ...
  },
  {
    ...
    t2: "$2,500",
    tagline:
      "Top ranked universities with strong post study work rights. We position your application.",
    ecHighlight:
    ...
    guided: [
      {
        cat: "Personal Statement, Collaborative Deep Dive",
        items: [
          "Compelling statement for Australian admissions",
          "Academic goals and reasons demonstrated",
          "Feedback until polished",
        ],
      },
      {
        ...
        items: [
          "Achievements highlighted for Australian standards",
          "Experience positioned effectively",
          "References strategy",
        ],
      },
      {
        cat: "Application Alignment",
        items: [
          "All materials as one cohesive package",
          "Every section reinforces fit",
        ],
      },
    ],
    complete: [
      ...
      },
      {
        ...
        items: [
          "Our EC developers build research projects and leadership roles",
          "Create scholarship worthy achievements",
          "Develop a profile competing for top merit awards",
        ],
      },
      {
        cat: "University Selection and Scholarship Strategy",
        items: [
          "Strategic list based on rankings and scholarship availability",
          "Merit awards and research scholarships identified",
          "Strategy optimized per institution",
        ],
      },
      {
        cat: "Scholarship Applications",
        items: [
          "Australia Awards and university scholarships",
          "All materials prepared",
          "Financial planning",
        ],
      },
    ...
    scholarships: [
      {
        ...
        detail: "Fully funded. Tuition, travel, and living",
      },
      {
        name: "University of Melbourne Scholarships",
        detail: "Up to full fee remission",
      },
      {
        name: "University of Sydney Scholarships",
        detail: "Merit based up to full tuition",
      },
      { name: "Monash Merit Scholarships", detail: "Awards up to $50,000" },
      {
        name: "Destination Australia",
        detail: "$15,000 per year for regional study",
      },
    ],
  },
  {
    ...
    t2: "$2,500",
    tagline:
      "World renowned universities with affordable tuition. We handle Campus France.",
    ecHighlight:
    ...
    guided: [
      {
        cat: "Motivation Letter, Collaborative Deep Dive",
        items: [
          "Letter in the style French universities expect",
          "Genuine interest and direction demonstrated",
          "Feedback until it meets French standards",
        ],
      },
      {
        cat: "Campus France Guidance",
        items: [
          "Step by step Campus France support",
          "Credential evaluation and documents",
      ...
      },
      {
        cat: "Application Alignment",
        items: [
          "Letter and profile as one cohesive package",
          "Every element demonstrates readiness",
        ],
      },
    ],
    complete: [
      {
        cat: "Motivation Letter, Written For You",
        items: [
          "Letter from scratch per university",
          "Deep interviews",
          "Unlimited revisions",
        ],
      },
      {
        cat: "Profile Development",
        items: [
          "Our team helps develop research and cultural exchange initiatives",
          "Build achievements French committees value",
          "Create an Eiffel worthy profile",
        ],
      },
      {
        ...
        items: [
          ...
          "All university applications prepared",
          "Timeline management",
        ],
      },
      {
    ...
    scholarships: [
      {
        ...
        detail: "French Government funded. Allowance, travel, and housing",
      },
      {
        name: "Erasmus Mundus Joint Masters",
        detail: "EU funded covering tuition, travel, and living",
      },
      {
        ...
        detail: "Full tuition waiver for undergraduates",
      },
      {
        name: "HEC Paris MBA Scholarships",
        detail: "Multiple merit and need based awards",
      },
    ],
  },
  {
    ...
    guided: [
      {
        cat: "Motivation Letter, Collaborative Deep Dive",
        items: [
          "Program specific letters for Dutch universities",
          "Clear academic fit demonstrated",
          "Feedback aligned to Dutch expectations",
        ],
      },
      {
        cat: "Academic Profile Optimization",
    ...
    complete: [
      {
        ...
        items: [
          "Separate letters per program from scratch",
          "Deep interviews",
          "Unlimited revisions",
        ],
      },
      {
        cat: "Innovation Profile Development",
        items: [
          "Our EC developers help build innovation or social enterprise projects",
          "Create initiatives reflecting Dutch problem solving culture",
          "Develop scholarship strengthening achievements",
        ],
      },
      {
        cat: "Full Application Management",
        items: [
          "Studielink and portal applications prepared",
          "Credential evaluation",
          "Timeline management",
        ],
      },
    ...
    scholarships: [
      { name: "Holland Scholarship", detail: "€5,000 for non-EEA students" },
      {
        ...
        detail: "Full tuition plus living",
      },
      {
        name: "Delft University Scholarships",
        detail: "Full tuition for MSc students",
      },
      {
        name: "University of Amsterdam Excellence",
        detail: "Full or partial tuition waiver",
      },
    ],
  },
  {
    ...
    guided: [
      {
        cat: "Personal Statement, Collaborative Deep Dive",
        items: [
          "Compelling statement for Irish admissions",
          "Academic motivation demonstrated",
          "Feedback until polished",
        ],
      },
      {
    ...
    complete: [
      ...
      },
      {
        cat: "Extracurricular Development",
        items: [
          "Our EC developers build academic and community projects",
          "Create leadership initiatives Irish universities value",
          "Develop a profile beyond just grades",
        ],
      },
      {
        cat: "University Selection and Scholarship Strategy",
        items: [
          ...
          "Scholarship identification per target",
    ...
    scholarships: [
      ...
      },
      {
        ...
        detail: "Significant fee reductions",
      },
  ...
  },
  {
    ...
    t2: "$1,500",
    tagline:
      "Turkiye Burslari and top universities at accessible prices. We handle everything.",
    ecHighlight:
    ...
    guided: [
      {
        ...
        items: [
          ...
          "Clear motivation demonstrated",
          "Feedback until standards met",
        ],
      },
      {
        ...
        items: [
          "Detailed study plan",
          "Supporting essays",
          "Extracurricular profile positioned",
        ],
      },
      {
        cat: "Application Alignment",
        items: [
          "Statement, plan, and essays as one package",
    ...
    complete: [
      ...
      {
        cat: "Volunteer and Leadership Development",
        items: [
          "Our EC developers design volunteer, social impact, and leadership projects",
          "Build community engagement Turkiye Burslari reviewers prioritize",
          "Create verifiable achievements before you apply",
        ],
      },
      {
        cat: "Full Turkiye Burslari Application",
        items: [
          "Complete application prepared",
          "Documents organized",
          "Interview preparation",
        ],
      },
      {
        ...
        items: [
          "Strategic list by scholarship success rates",
    ...
    scholarships: [
      {
        ...
        detail:
          "Fully funded. Tuition, accommodation, stipend, insurance, and language course",
      },
      {
        name: "Sabanci University Scholarships",
      ...
      },
      {
        ...
        detail: "100% waiver for high achievers",
      },
    ],
  },
  {
    ...
    ecHighlight:
      "We develop design portfolios, technical projects, and academic initiatives for Politecnico di Milano, Bocconi, and beyond",
    guided: [
      {
        cat: "Motivation Letter, Collaborative Deep Dive",
        items: [
    ...
    complete: [
      {
        cat: "Motivation Letter, Written For You",
        items: ["From scratch", "Deep interviews", "Unlimited revisions"],
      },
      {
        cat: "Portfolio and Project Development",
        items: [
          "Our EC developers help build design portfolios, technical projects, or research",
          "Create achievements top Italian programs value",
          "Develop a merit scholarship competitive profile",
        ],
      },
      {
        cat: "University Selection",
        items: [
          "Politecnico, Bocconi, Bologna and more",
          "Program matching",
      ...
      },
      {
        cat: "Scholarship Applications",
        items: [
          "Invest Your Talent in Italy, DSU, and university awards",
          "All materials prepared",
          "Financial planning",
        ],
      },
    ...
    scholarships: [
      {
        ...
        detail: "Italian Government scholarships",
      },
      {
        name: "DSU Regional Scholarships",
        detail: "Tuition, accommodation, and meals",
      },
      {
        name: "Politecnico di Milano Merit",
        detail: "Full tuition plus €5,000 per year",
      },
  ...
  },
  {
    ...
    ecHighlight:
      "We build sustainability projects, innovation initiatives, and social entrepreneurship profiles that Nordic universities prioritize",
    guided: [
      {
        cat: "Motivation Letter, Collaborative Deep Dive",
        items: [
          "Program specific letters for Nordic applications",
          "Genuine fit demonstrated",
          "Feedback aligned to Scandinavian standards",
        ],
      },
      {
        cat: "Profile Optimization",
        items: [
    ...
    complete: [
      ...
      },
      {
        ...
        items: [
          ...
          "Create initiatives aligned with Nordic values",
          "Develop scholarship winning achievements",
        ],
      },
      {
        cat: "University Selection",
        items: [
          "Strategic list across Sweden, Finland, Denmark",
          "Tuition free Finnish programs identified",
    ...
    scholarships: [
      {
        ...
        detail: "Full tuition, living, and travel for Masters",
      },
      {
        name: "EDUFI Fellowships (Finland)",
        detail: "Monthly grant for doctoral research",
      },
      {
        name: "University of Helsinki Scholarships",
        detail: "Full tuition waiver for Masters",
      },
      {
      ...
      },
      {
        ...
        detail: "Full tuition for engineering applicants",
      },
    ],
  },
  {
    ...
    ecHighlight:
      "We develop clinical volunteering, medical shadowing portfolios, and academic projects specifically for medical school and engineering applications",
    guided: [
      {
        cat: "Motivation Letter, Collaborative Deep Dive",
        items: [
          "Compelling letter for Eastern European universities",
          "Academic readiness demonstrated",
          "Feedback until polished",
        ],
      },
      {
    ...
    complete: [
      ...
      },
      {
        ...
        items: [
          "Our EC developers build clinical volunteering, hospital shadowing, and lab research portfolios",
          "Create the medical or engineering extracurricular profile competitive programs require",
          "Develop achievements setting you apart from other internationals",
        ],
      },
      {
        cat: "University Selection",
        items: [
          "Strategic list across Hungary, Poland, Czech Republic",
          "Medical, engineering, and business focus",
          "Scholarship identification",
        ],
      },
      {
        cat: "Scholarship Applications",
        items: [
          "Stipendium Hungaricum, NAWA, Czech Government scholarships",
          "All materials prepared",
    ...
    scholarships: [
      ...
      },
      {
        ...
        detail: "Partial tuition for medical students",
      },
    ],
  },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          selection, scholarship strategy. Everything except the visa.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            },
            {
              ...
              desc: "Data backed university selection that goes beyond rankings. We match you with schools where your specific profile has the highest chance of admission and scholarships.",
            },
            {
              icon: "💰",
      ...
      >
        ...
        <p
          ...
          style={{ color: "#94a3b8" }}
        >
          We have helped students from across the globe build profiles, win
          scholarships, and land admits at dream schools in 15 countries. We
          cover everything except the visa. We don't do cookie cutter. Neither
          should you.
        </p>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl relative max-h-screen overflow-y-auto">
            ...
            {!done ? (
              <div className="px-6 py-6 flex flex-col gap-4">
                ...
                <button
                  onClick={() => {
                    if (form.name && form.email && form.country) setDone(true);
                  }}
              ...
              <div className="px-6 py-10 text-center">
                ...
                <button
                  ...
                  onClick={() =>
                    window.open(
                      `https://wa.me/${WA}?text=${encodeURIComponent(`Hi! I just registered. My name is ${form.name} from ${form.country}.`)}`,
                      "_blank",
                    )
                  }
                >
